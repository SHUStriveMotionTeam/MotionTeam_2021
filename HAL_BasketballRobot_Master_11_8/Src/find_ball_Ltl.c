...
u8 MoveOfFindingBallByVision()
{
	...
	{
		GetMotorVelocity_Self(0, 2000, -70);
	...
	{
		GetMotorVelocity_Self(0, 2000, 0);
		Set_MotorSpeed(Motor[0].SetSpeed, Motor[1].SetSpeed,
					   Motor[2].SetSpeed, Motor[3].SetSpeed);
		return 1;
	}		
	...
	{
		GetMotorVelocity_Self(0,1500,120);
		Set_MotorSpeed(Motor[0].SetSpeed, Motor[1].SetSpeed,
					   Motor[2].SetSpeed, Motor[3].SetSpeed);
		return 1;
	}
	...
	{
		GetMotorVelocity_Self(0,1000,150);
		Set_MotorSpeed(Motor[0].SetSpeed, Motor[1].SetSpeed,
					   Motor[2].SetSpeed, Motor[3].SetSpeed);
		return 1;
	}
...
{
	if (INFRARED == 1 || Radar.Distance < 260)
		return 0;	
